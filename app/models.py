...
class Movie:
    def __init__(self, movie_data):
        ...
        self.overview = self.get_overview(movie_data)
    ...
    def to_dict(self):
        return {
            ...
            'genres': [{'id': genre['id'], 'name': genre['name']} for genre in self.genres if isinstance(genre, dict)], 
    ...
    def parse_list_field(self, field_value):
        if isinstance(field_value, str) and field_value.strip() != '':
            try:
                ...
                print(f"Error decoding JSON for value: {field_value}")  
